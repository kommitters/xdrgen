...
defmodule MyXDR.DoubleFloat do
  @behaviour XDR.Declaration
...
defmodule MyXDR.FixedOpaque  do
  @behaviour XDR.Declaration
...
defmodule MyXDR.VariableOpaque do
  @behaviour XDR.Declaration
